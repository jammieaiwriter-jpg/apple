...
- 首頁下方提供 Podcast 式第一季故事選單；今晚故事、草稿試聽與規劃中集數有清楚狀態。每集右側顯示核心詞與注音，點可播放故事會立即開始朗讀。
...
`stories/catalog.json` 保存十二週 Podcast 選單、核心詞注音與完成狀態；`stories/current.json` 只控制今晚正式故事。
